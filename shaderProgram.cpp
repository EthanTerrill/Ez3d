...
//none of this needs to be here intellisense is just  abitch if you dont put it there
...
public:
    ...
    shaderProgram(std::string vertexFile, std::string fragmentFile) {
        ...
        const char *vertexShaderSource   = vertShader.getShaderSource();
        const char *fragmentShaderSource = fragShader.getShaderSource();
